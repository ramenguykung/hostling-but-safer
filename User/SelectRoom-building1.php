  ...
  <body>
    ...
    <div class="divSR">
      ...
      if ($act == 'flor5') {
        include('room_from_flor5_building_1.php');
      } elseif ($act == 'flor4') {
        include('room_from_flor4_building_1.php');
      } elseif ($act == 'flor3') {

        include('room_from_flor3_building_1.php');
      } else if ($act == 'flor2') {

        include('room_from_flor2_building_1.php');
      } else if ($act == 'flor1') {

        include('room_from_flor1_building_1.php');
      }
      ?>
    </div>
  </body>
