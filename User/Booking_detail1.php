...
ORDER BY p.Id_Room  DESC" or die("Error:" . mysqli_error());
    ...
    <div class="top-navigation-mainhome">
        ...
        <div class="left-navH">
            <div class="menu-dividerH">
                <a class="btn btn-Light" href="Booking_page1.php?act=<?php echo $row["building_1_id"] ?>&ID=<?php echo $row["Id_Room"] ?>" role="button" style="text-decoration: none;">
    ...
    <div class="divBooking_detail">
        ...
        <form name="register" action="Booking-process-1.php" method="POST" enctype="multipart/form-data" class="form-horizontal" onsubmit="handleSubmit(event)">
            ...
            <input type="hidden" name="building_id" value="<?php echo $row['building_1_id']; ?>">
            ...
            <div class="flex-column-div-data">
                <div class="flex-row-divdataform">
                    ...
                    <div class="flex-column-divd-atatext">
                        ...
                        <h1 class="textdata"><?php echo $row['building_1_id']; ?></h1>
                    </div>
    ...
    // ตรวจสอบว่า totalGuest เป็นตัวเลข
    ...
    if (totalGuest > 3) {
        alert('จำนวนคนเข้าพักต้องไม่มากกว่า 3 คน.');
        return;
    }
