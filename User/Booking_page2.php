...
<head>
  ...
  <script src="../bootstrap/js/bootstrap.bundle.min.js"></script><link rel="icon" href="../icon/LogoBC.png" type="image/x-icon">
    ...
    <div class="flex-row-divB">
      ...
      <div class="flex-row-divtextBin">
        ...
        <div class="AC">
          ...
          <h1 class="textmain"><?php echo $row["building_2_id"] ?></h1>
        </div>
      </div>
      ...
      <div class="flex-row-div-data">
        ...
        <div class="dataroom">
          ...
          <a href="Booking_detail2.php?act=Booking_detail-2/1&ID=<?php echo $row["Id_Room"] ?>" style="text-decoration: none;">
            <button class="Button">
