...
// ตรวจสอบว่า $_POST['ID'] ถูกตั้งค่าหรือไม่
    ...
    <div class="Payment">
        ...
        <div class="PaymentRight">
            <div class="text-Detailpayment">
                <a>ค่ามัดจำ: <?php echo $rentalDepositAmountcash ?> </a><br>
                <a>จำนวนเงินที่ต้องชำระ ณ วันทำสัญญา: <?php echo $rentalDepositAmountcash ?></a><br>
                <a>ค่าใช้จ่ายทั้งหมด: <?php echo $rentalDepositAmountcash ?></a>
            </div>
            <form name="register" action="Payment-process-cash.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                <input type="hidden" name="Method" value="cash">
                <input type="hidden" name="booking_id" value="<?php echo $booking_id ?>">
                <input type="hidden" name="Totalexpenses" value="<?php echo $rentalDepositAmountcash ?>">
                <input type="hidden" name="Payoncontractdate" value="<?php echo $rentalDepositAmountcash ?>">
