    ...
    <div class="containers">
        <div class="frame">
            <div class="frameinput2">
                ...
                <input name="Name" id="Name" class="input1" type="text" value="<?php echo $row['user_name']; ?>" required>
                <h5 class="fip3">Last name</h5>
                <br>
                <input name="Surname" id="Surname" class="input1" type="text" value="<?php echo $rowuser['Surname']; ?>" required>
                <br>
                ...
                <div class="ntED">
                    <input name="Day" id="Day" class="input1 " type="text" required list="day-options" value="<?php echo $rowusers['user_Day']; ?>">
                    ...
                    <input name="Month" id="Month" class="inputMonthED " type="text" required list="Month-options" value="<?php echo $rowuser['user_Month']; ?>">
                    ...
                    <input name="Year" id="Year" class="input1 " type="text" list="Year-options" value="<?php echo $rowuser['user_Year']; ?>" required>
                ...
                <input name="Age" id="Age" class="input1" type="text" value="<?php echo $rowuser['Age']; ?>" required>
                <br>
                <h5 class="fip99">Gender</h5>
                <select name="Gender" id="Gender" class="input" required>
                    <option value="<?php echo $row['Gender']; ?>"><?php echo $rowuser['Gender']; ?></option>
                ...
                <br>
                <input name="Phone" id="phonenumber" class="input" type="text" value="<?php echo $rowuser['Phone']; ?>" required>
                <br>
                <h5 class="fip100">Resident Registration Address</h5>
                <input name="Card_Address" id="Card_Address" class="input" type="text" value="<?php echo $rowuser['Card_Address']; ?>" required>
                <br>
                <h5 class="fip111">Job</h5>
                <input name="Job" id="Job" class="input" type="text" value="<?php echo $rowuser['Job']; ?>" required>
