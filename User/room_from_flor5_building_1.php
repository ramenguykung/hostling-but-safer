                    ...
                    <div class="flex-column-divSR3">
                        ...
                        <div class="flex-row-divSR2">
                            ...
                            ?>
                                ...
                                <a class="btn btn-Light" href="Booking_page1.php?act=Booking1/1&ID=<?php echo $row["Id_Room"] ?>" role="button" style="text-decoration: none;">
