...
<form  name="register" action="room_process_edit_building_1.php" method="POST" enctype="multipart/form-data" class="form-horizontal"  >
<div class="divEdit">
    <div class="divEditin">
    ...
    <div class="Admin-room-createFrame82">
             ...
             <div class="Addroomflex-row-div1">
                 ...
                 <option value="<?php echo $results["building_1_id"];?>">
                   <?php echo $results["floor"]; ?>
                         ...
                         <input type="hidden" name="Room_Dimensions" value="<?php echo $row['Room_Dimensions'];?>" /> 
                         <input type="hidden" name="ค่าไฟ" value="<?php echo $row['ค่าไฟ'];?>" /> 
                         <input type="hidden" name="ค่าน้ำ" value="<?php echo $row['ค่าน้ำ'];?>" /> 
             ...
             <div class="Addroomflex-row-div2">
                         ...
                         <div class="divAddroom">
                                       ...
                                       <textarea name="RoomDetails" class="AddroomFrame84" type="text" required><?php echo $row['RoomDetails'];?></textarea>
                                       </div>
