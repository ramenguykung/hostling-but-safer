...
<h class= "text2"><?php echo $row["RoomNumber"]?> | <h class= "text1">floor:</h><?php echo $row["floor"]?>  | <h class= "text1">Building:</h> <?php echo $row["Building"]?></h>  </h>
</div>
...
?>
    ...
    <div class="flex-column-div">
        <h class="text1">status:</h>
        <h class="text2"><?php echo $row["Statuss"]; ?></h>
    </div>
...
<h class= "text2"><?php echo $row["Date_booking"]?></h>
 ...
 <button  class="ButtonBookingdetai" id="btn"> <h6 class="messageBookingdetails">Booking details</h6>
 </button> 
